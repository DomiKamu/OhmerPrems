...
- **FroeZe-X**, an **right-side** expander module for FroeZe sequencer. It brings additional outputs for ACcents, plus some edit features.
- COMING SOON: **FroeZe-SP-X**, an **left-side** expander module for FroeZe sequencer. It brings additional inputs for track-based SWING or PROBAbility. **Remaining in development...**
