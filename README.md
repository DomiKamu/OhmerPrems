...
- **Vektor** is a 16HP polyphonic digital quad-oscillator VCO module, using Vector Synthesis (VS). [**Vektor User's Manual** incl. **VX** expander](docs/modules/Vektor/Manual.md) (_Vektor_ module still under development, available as **v2.6.13 BETA** (pre-release), planned as future stable release v2.6.13 during August 2026).
