...
- **Vektor** is a 16HP polyphonic quad-oscillator VCO module, using Vector Synthesis (VS). [**Vektor User's Manual** (incl. **VX** and **VI** expander modules)](docs/modules/Vektor/Manual.md) (_Vektor_ module and its User's Manual are under construction, both are **planned for future release v2.6.13**).
