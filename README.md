...
- **6OP-DX Kompakt** will be the "free player" of 6OP-DX, largely smaller (estimated 40~42HP), without DX7 edit features. Will be compatible vs. DX7 SysEx files (import only), and .6opdx file format (cartridge files generated by the _6OP-DX_ module, but with extended features).
