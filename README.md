...
- **Vektor** is a 16HP quad-oscillator VCO module, using Vector Synthesis. [**Vektor User's Manual** (incl. **VX** expander)](docs/modules/Vektor/Manual.md) (module and manual is under construction, will be available from next v2.6.13).
