...
- COMING SOON: **Entirely free KlokSpid MkII** - the successor of (2017) *KlokSpid* - a 16HP CPU-controlled clocking module, 8 analog (wavetable-based) outputs, 6 configurable CV modulators (upto 14 CV inputs, by using KX expander and changing both "CLK" and "RUN" input roles). KlokSpid MkII will output triggers (+1ms 10V), ratchets, gates, envelopes / LFO (1-bar length), S&H/random, audio...
