...
- **Vektor** is a 16HP polyphonic quad-oscillator VCO module, using Vector Synthesis (VS). [**Vektor User's Manual** (incl. **VX** expander)](docs/modules/Vektor/Manual.md) (both Vektor module and manual are under construction, both are **planned for future release v2.6.13**).
