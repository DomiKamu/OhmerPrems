...
- **6OP-DX Kompakt** will be the compact "free player" version of 6OP-DX, largely thin (34HP), but without any DX7 edit features (except MONOPHONIC toggle). Like 6OP-DX, it will be compatible with DX7 SysEx files (import only), and .6opdx file format (32-voice cartridge files, generated by the _6OP-DX_ module, with extended features).
