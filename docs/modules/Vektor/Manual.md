...
This scheme is always used by VS-based hardware synthesizers, such Sequential Circuits Prophet VS (1986), Yamaha SY22 series (1990), Korg Wavestation (1990), and Korg wavestate (since 2004), Behringer Pro VS Mini (2025), and Victor (as Eurorack module).
